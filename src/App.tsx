    ...
    <div className="font-body bg-background text-zinc-900 antialiased selection:bg-primary selection:text-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "24/7 Emergency locksmith services in Houston, TX and College Station, TX. Specializing in car lockouts, home lockouts, commercial lockouts, rekey services, and automotive key programming.",
            ...
            "availableService": [
              { "@type": "Service", "name": "Car Lockout", "description": "Emergency car lockout service with zero damage guarantee" },
              { "@type": "Service", "name": "Home Lockout", "description": "Residential lockout assistance for houses and apartments" },
              { "@type": "Service", "name": "Commercial Lockout", "description": "Business and office lockout emergency response" },
              { "@type": "Service", "name": "Safe Lockout", "description": "Professional safe opening and lockout service" },
              { "@type": "Service", "name": "Residential Rekey", "description": "Complete home rekey services for security" },
              { "@type": "Service", "name": "Commercial Rekey", "description": "Office and business rekey services" },
              { "@type": "Service", "name": "Car Key Replacement", "description": "Automotive key cutting and programming" },
              { "@type": "Service", "name": "Chip Key Programming", "description": "Transponder chip key programming for all vehicle makes" },
              { "@type": "Service", "name": "Key Cutting", "description": "Precision key cutting service" },
              { "@type": "Service", "name": "Remote Programming", "description": "Car remote and key fob programming" }
            ],
            "hasOfferCatalog": {
              "@type": "OfferCatalog",
              ...
              "itemListElement": [
                "Car Lockout - Houston",
                "Home Lockout - Houston",
                "Commercial Lockout - Houston",
                "Safe Lockout - Houston",
                "Car Lockout - College Station",
                "Home Lockout - College Station"
              ]
            }
          })
        }}
      ...
      <header className="bg-white/95 backdrop-blur-sm flex justify-center items-center w-full px-6 py-4 fixed top-0 z-50 transition-all duration-150 linear border-b border-zinc-200 shadow-sm">
        <div className="flex flex-col md:flex-row items-center gap-3">
          ...
          <a href="tel:7135550199" className="hidden md:flex items-center gap-2 text-zinc-700 font-bold text-sm hover:text-primary transition-colors">
            <Phone size={14} />
            (713) 555-0199
          </a>
        </div>
      ...
      <main className="pt-20">
        ...
        {/* Service Areas - Important for LLMs */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="font-body text-zinc-300 font-bold uppercase text-sm tracking-wider mb-6">
                  We provide 24/7 emergency locksmith services throughout Houston and Greater Areas including College Station, Texas.
                </p>
        ...
        <section className="bg-white py-20 px-6" aria-labelledby="owner-heading">
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                {/* PLACEHOLDER: Replace with actual photo of your client */}
                <div className="aspect-[4/5] bg-zinc-200 border-4 border-primary flex items-center justify-center">
                  <div className="text-center p-8">
                    <Unlock className="w-16 h-16 text-zinc-400 mx-auto mb-4" />
                    <p className="text-zinc-500 font-bold uppercase text-sm">
                      Insert Owner Photo Here
                    </p>
                    <p className="text-zinc-400 text-xs mt-2">
                      Professional locksmith in uniform
                    </p>
                  </div>
                </div>
                {/*
                  ...
                  <img
                    ...
                    alt="Professional locksmith technician in uniform - CarLocksOut owner"
                    className="w-full h-auto border-4 border-primary shadow-xl"
                  />
                */}
              </div>
              <div>
